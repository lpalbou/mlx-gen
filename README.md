...
- MiniMax-H3 text-to-video and image-to-video **with synchronized stereo audio** (`minimax-h3`,
  ...
  long, with the lightx2v 8-step Turbo adapters attached automatically; run it with `--quantize 8`
  or from a prepared 75 GB q8 package (`mlxgen prepare`) on a 128 GB Mac (see `docs/minimax-h3.md`);
