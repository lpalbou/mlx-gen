...
- [Quantization](quantization.md): current low-bit compatibility by model family, including the complete published package matrix, validation panels, Bonsai ternary 2-bit support, Qwen and ERNIE mixed q4/q8 policies, and Wan TI2V/A14B package status.
