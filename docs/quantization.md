...
| MiniMax-H3 | Supported with mixed q8/BF16 at load time | Not validated | `--quantize 8` quantizes the transformer attention/feed-forward linears and the Qwen3-VL conditioner shard by shard while loading; the fp32 heads, timestep MLP and AdaLN modulation projections keep their source precision. No package is published yet. |
